...
CREATE TABLE `chitietnhapsach` (
  ...
  `phieunhapsach_id` int NOT NULL,
  PRIMARY KEY (`product_id`,`phieunhapsach_id`),
  KEY `phieunhapsach_id` (`phieunhapsach_id`),
  CONSTRAINT `chitietnhapsach_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `chitietnhapsach_ibfk_2` FOREIGN KEY (`phieunhapsach_id`) REFERENCES `phieunhapsach` (`id`)
