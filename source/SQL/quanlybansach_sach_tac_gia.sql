...
CREATE TABLE `sach_tac_gia` (
  ...
  PRIMARY KEY (`tacgia_id`,`product_id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `sach_tac_gia_ibfk_1` FOREIGN KEY (`tacgia_id`) REFERENCES `tac_gia` (`id`),
  CONSTRAINT `sach_tac_gia_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
